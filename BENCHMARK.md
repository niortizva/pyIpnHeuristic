...
$$ g_5 (\mathbf{x}) = 213.1 - y_1 \leq 0 $$ $$ g_6(\mathbf{x}) = y_1 - 405.23 \leq 0 $$ $$ g_7(\mathbf{x}) = 17.505 - y_2 \leq 0 $$
$$ g_8 (\mathbf{x}) = y_2 - 1053.6667 \leq 0 $$ $$ g_9(\mathbf{x}) = 11.275 - y_3 \leq 0 $$ $$ g_{11}(\mathbf{x}) = 214.228 - y_4 \leq 0 $$
$$ g_{12} (\mathbf{x}) = y_4 - 665.585 \leq 0 $$ $$ g_{13}(\mathbf{x}) = 7.458 - y_5 \leq 0 $$ $$ g_{14}(\mathbf{x}) = y_5 - 584.463 \leq 0 $$
$$ g_{15} (\mathbf{x}) = 0.961 - y_6 \leq 0 $$ $$ g_{16}(\mathbf{x}) = y_6 - 265.916 \leq 0 $$ $$ g_{10}(\mathbf{x}) = y_3 - 35.03 \leq 0 $$
$$ g_{17} (\mathbf{x}) = 1.612 - y_7 \leq 0 $$ $$ g_{18}(\mathbf{x}) = y_7 - 7.046 \leq 0 $$ $$ g_{19}(\mathbf{x}) = 0.146 - y_8 \leq 0 $$
$$ g_{20} (\mathbf{x}) = y_8 - 0.222 \leq 0 $$ $$ g_{21}(\mathbf{x}) = 107.99 - y_9 \leq 0 $$ $$ g_{22}(\mathbf{x}) = y_9 - 273.366 \leq 0 $$
...
$c_{15} = y_{13} / y_{15} - y_{13} / 0.52$, $c_{16} = 1.104 - 0.72 y_{15}$, $c_{17} = y_9 + x_4$ and
